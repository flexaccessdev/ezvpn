...
// On-disk TOML loading is desktop-only (the mobile runtime config arrives as
// JSON through the FFI; the default paths resolve via
// `crate::runtime::config_dir`, a module not built on iOS/Android).
